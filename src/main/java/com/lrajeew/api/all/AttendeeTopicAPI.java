...
public class AttendeeTopicAPI extends BaseAttendeesAPI {
	private static AttendeeTopicAPI apiCall;

	private AttendeeTopicAPI() {
	}

	public static AttendeeTopicAPI getInstance() {
		if (apiCall == null) {
			apiCall = new AttendeeTopicAPI();
		}
		return apiCall;
	}
