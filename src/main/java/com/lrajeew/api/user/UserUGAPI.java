...
public class UserUGAPI extends BaseAPI {
	private static UserUGAPI apiCall;

	private UserUGAPI() {
	}

	public static UserUGAPI getInstance() {
		if (apiCall == null) {
			apiCall = new UserUGAPI();
		}
		return apiCall;
	}

	private static Logger LOGGER = Logger.getLogger(UserUGAPI.class);
