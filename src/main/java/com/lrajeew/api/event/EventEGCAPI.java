...
public class EventEGCAPI extends BaseAPI {
	private static EventEGCAPI apiCall;

	private EventEGCAPI() {
	}

	public static EventEGCAPI getInstance() {
		if (apiCall == null) {
			apiCall = new EventEGCAPI();
		}
		return apiCall;
	}
	...
	@Info(url="/events/<eventKey>,<eventKey>,…")
	public ClientResponse query(AuthenticationVO authData,
		...
		String apiEndpoint = ApiConsatants.VIVA_API + "events/vivacon,ICCSL20,?"+ "rep="+responseType.getType();
