...
public class EventStreamItemEStrIGAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventStreamItemEStrIGAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventStreamItemEStrIGAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = EventStreamItemEStrIGAPI.getInstance();
