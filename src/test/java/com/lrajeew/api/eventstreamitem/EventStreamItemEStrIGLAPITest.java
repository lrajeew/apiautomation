...
public class EventStreamItemEStrIGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventStreamItemEStrIGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventStreamItemEStrIGLAPI";
