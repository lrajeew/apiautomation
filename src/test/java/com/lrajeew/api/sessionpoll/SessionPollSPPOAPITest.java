...
public class SessionPollSPPOAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(SessionPollSPPOAPITest.class);
	
	private static String FILE_NAME_PREFIX = "SessionPollSPPOAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = SessionPollSPPOAPI.getInstance();
