...
public class EventPollEPPOAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventPollEPPOAPITest.class);
	...
	public void loadDataFromFile() throws IOException {
		...
		instance = EventPollEPPOAPI.getInstance();
