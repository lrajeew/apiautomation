...
public class ExternalContentECPOAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(ExternalContentECPOAPITest.class);
	
	private static String FILE_NAME_PREFIX = "ExternalContentECPOAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = ExternalContentECPOAPI.getInstance();
