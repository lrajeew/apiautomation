...
public class EventTopicAttendeeETAinGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventTopicAttendeeETAinGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventTopicAttendeeETAinGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = EventTopicAttendeeETAinGLAPI.getInstance();
