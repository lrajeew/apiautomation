...
public class SessionSpeakerSSGLTest extends APITest{

	private static Logger LOGGER = Logger.getLogger(SessionSpeakerSSGLTest.class);
	
	private static String FILE_NAME_PREFIX = "SessionSpeakerSSGL";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = SessionSpeakerSSGL.getInstance();
