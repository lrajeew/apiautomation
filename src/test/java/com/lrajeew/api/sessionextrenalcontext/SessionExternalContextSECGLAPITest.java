...
public class SessionExternalContextSECGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(SessionExternalContextSECGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "SessionExternalContextSECGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = SessionExternalContextSECGLAPI.getInstance();
