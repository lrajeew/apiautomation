...
public class UserConvoMessageReaderUCMRPUAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserConvoMessageReaderUCMRPUAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserConvoMessageReaderUCMRPUAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserConvoMessageReaderUCMRPUAPI.getInstance();
