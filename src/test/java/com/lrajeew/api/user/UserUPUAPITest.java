...
public class UserUPUAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserUPUAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserUPUAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserUPUAPI.getInstance();
