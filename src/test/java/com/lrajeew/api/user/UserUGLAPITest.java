...
public class UserUGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserUGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserUGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserUGLAPI.getInstance();
