...
public class UserUG1APITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserUG1APITest.class);
	
	private static String FILE_NAME_PREFIX = "UserUG1API";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserUG1API.getInstance();
