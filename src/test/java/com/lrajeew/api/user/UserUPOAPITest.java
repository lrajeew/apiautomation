...
public class UserUPOAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserUPOAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserUPOAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserUPOAPI.getInstance();
