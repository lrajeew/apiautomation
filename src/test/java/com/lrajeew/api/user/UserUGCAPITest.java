...
public class UserUGCAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserUGCAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserUGCAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserUGCAPI.getInstance();
