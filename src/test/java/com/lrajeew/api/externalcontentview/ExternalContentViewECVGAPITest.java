...
public class ExternalContentViewECVGAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(ExternalContentViewECVGAPITest.class);
	
	private static String FILE_NAME_PREFIX = "ExternalContentViewECVGAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = ExternalContentViewECVGAPI.getInstance();
