...
public class UserConvoMessageUCMGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserConvoMessageUCMGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserConvoMessageUCMGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserConvoMessageUCMGLAPI.getInstance();
