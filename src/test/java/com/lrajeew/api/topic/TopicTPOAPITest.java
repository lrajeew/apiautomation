...
public class TopicTPOAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(TopicTPOAPITest.class);
	
	private static String FILE_NAME_PREFIX = "TopicTPOAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = TopicTPOAPI.getInstance();
