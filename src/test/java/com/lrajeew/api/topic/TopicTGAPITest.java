...
public class TopicTGAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(TopicTGAPITest.class);
	
	private static String FILE_NAME_PREFIX = "TopicTGAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = TopicTGAPI.getInstance();
