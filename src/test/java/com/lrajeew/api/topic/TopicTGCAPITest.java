...
public class TopicTGCAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(TopicTGCAPITest.class);
	
	private static String FILE_NAME_PREFIX = "TopicTGCAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = TopicTGCAPI.getInstance();
