...
public class UserPollResponseUPRGAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserPollResponseUPRGAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserPollResponseUPRGAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserPollResponseUPRGAPI.getInstance();
