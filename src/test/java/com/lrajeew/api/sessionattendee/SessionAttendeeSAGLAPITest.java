...
public class SessionAttendeeSAGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(SessionAttendeeSAGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "SessionAttendeeSAGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = SessionAttendeeSAGLAPI.getInstance();
