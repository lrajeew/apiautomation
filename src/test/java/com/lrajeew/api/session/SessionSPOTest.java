...
public class SessionSPOTest extends APITest {

	private static Logger LOGGER = Logger.getLogger(SessionSPOTest.class);

	private static String FILE_NAME_PREFIX = "SessionSPO";
