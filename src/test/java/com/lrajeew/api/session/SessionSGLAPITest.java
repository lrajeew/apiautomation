...
public class SessionSGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(SessionSGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "SessionSGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = SessionSGLAPI.getInstance();
