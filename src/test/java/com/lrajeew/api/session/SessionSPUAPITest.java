...
public class SessionSPUAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(SessionSPUAPITest.class);
	
	private static String FILE_NAME_PREFIX = "SessionSPUAPI";
