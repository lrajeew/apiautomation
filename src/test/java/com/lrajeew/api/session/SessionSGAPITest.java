...
public class SessionSGAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(SessionSGAPITest.class);
	
	private static String FILE_NAME_PREFIX = "SessionSGAPI";
