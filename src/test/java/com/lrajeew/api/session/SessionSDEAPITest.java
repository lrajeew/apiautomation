...
public class SessionSDEAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(SessionSDEAPITest.class);
	
	private static String FILE_NAME_PREFIX = "SessionSDEAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = SessionSDEAPI.getInstance();
