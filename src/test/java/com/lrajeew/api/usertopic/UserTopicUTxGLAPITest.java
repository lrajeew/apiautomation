...
public class UserTopicUTxGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserTopicUTxGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserTopicUTxGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserTopicUTxGLAPI.getInstance();
