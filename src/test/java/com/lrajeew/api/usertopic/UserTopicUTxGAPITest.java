...
public class UserTopicUTxGAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserTopicUTxGAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserTopicUTxGAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserTopicUTxGAPI.getInstance();
