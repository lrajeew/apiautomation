...
public class UserTopicUTGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserTopicUTGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserTopicUTGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserTopicUTGLAPI.getInstance();
