...
public class UserTopicUTxGCAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserTopicUTxGCAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserTopicUTxGCAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserTopicUTxGCAPI.getInstance();
