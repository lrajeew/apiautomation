...
public class StreamItemStrIGAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(StreamItemStrIGAPITest.class);
	
	private static String FILE_NAME_PREFIX = "StreamItemStrIGAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = StreamItemStrIGAPI.getInstance();
