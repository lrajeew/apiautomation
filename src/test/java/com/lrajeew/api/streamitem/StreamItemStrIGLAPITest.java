...
public class StreamItemStrIGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(StreamItemStrIGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "StreamItemStrIGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = StreamItemStrIGLAPI.getInstance();
