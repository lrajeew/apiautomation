...
public class EventTopicETxGCAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventTopicETxGCAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventTopicETxGCAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = EventTopicETxGCAPI.getInstance();
