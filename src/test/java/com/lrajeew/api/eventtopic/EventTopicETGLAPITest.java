...
public class EventTopicETGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventTopicETGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventTopicETGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = EventTopicETGLAPI.getInstance();
