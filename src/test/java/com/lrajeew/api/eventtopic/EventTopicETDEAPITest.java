...
public class EventTopicETDEAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventTopicETDEAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventTopicETDEAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = EventTopicETDEAPI.getInstance();
