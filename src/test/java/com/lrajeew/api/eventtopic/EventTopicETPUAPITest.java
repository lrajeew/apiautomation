...
public class EventTopicETPUAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventTopicETPUAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventTopicETPUAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = EventTopicETPUAPI.getInstance();
