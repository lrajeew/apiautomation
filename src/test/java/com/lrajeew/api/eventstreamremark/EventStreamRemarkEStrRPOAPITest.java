...
public class EventStreamRemarkEStrRPOAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventStreamRemarkEStrRPOAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventStreamRemarkEStrRPOAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = EventStreamRemarkEStrRPOAPI.getInstance();
