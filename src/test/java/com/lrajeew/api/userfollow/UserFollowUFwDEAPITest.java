...
public class UserFollowUFwDEAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserFollowUFwDEAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserFollowUFwDEAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserFollowUFwDEAPI.getInstance();
