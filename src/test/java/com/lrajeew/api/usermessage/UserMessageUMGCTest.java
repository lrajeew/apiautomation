...
public class UserMessageUMGCTest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserMessageUMGCTest.class);
	
	private static String FILE_NAME_PREFIX = "UserMessageUMGC";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserMessageUMGC.getInstance();
