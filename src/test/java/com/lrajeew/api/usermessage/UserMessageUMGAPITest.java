...
public class UserMessageUMGAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserMessageUMGAPITest.class);
	...
	public void loadDataFromFile() throws IOException {
		...
		instance = UserMessageUMGAPI.getInstance();
