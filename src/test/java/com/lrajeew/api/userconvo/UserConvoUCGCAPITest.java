...
public class UserConvoUCGCAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserConvoUCGCAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserConvoUCGCAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserConvoUCGCAPI.getInstance();
