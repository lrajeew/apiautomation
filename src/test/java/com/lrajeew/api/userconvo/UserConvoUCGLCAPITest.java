...
public class UserConvoUCGLCAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserConvoUCGLCAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserConvoUCGLCAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserConvoUCGLCAPI.getInstance();
