...
public class UserConvoUCGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(UserConvoUCGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "UserConvoUCGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = UserConvoUCGLAPI.getInstance();
