...
public class EventTopicAttendeeETAGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventTopicAttendeeETAGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventTopicAttendeeETAGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = EventTopicAttendeeETAGLAPI.getInstance();
