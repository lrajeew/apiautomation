...
public class EventTopicAttendeeETAxGAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventTopicAttendeeETAxGAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventTopicAttendeeETAxGAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = EventTopicAttendeeETAxGAPI.getInstance();
