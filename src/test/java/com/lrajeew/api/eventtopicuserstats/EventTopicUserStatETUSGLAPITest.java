...
public class EventTopicUserStatETUSGLAPITest extends APITest{

	private static Logger LOGGER = Logger.getLogger(EventTopicUserStatETUSGLAPITest.class);
	
	private static String FILE_NAME_PREFIX = "EventTopicUserStatETUSGLAPI";

	@Override
	public void loadDataFromFile() throws IOException {
		super.loadDataFromFile();
		instance = EventTopicUserStatETUSGLAPI.getInstance();
